...
function addSettingsFields() {
    if (typeof Lampa.SettingsApi !== 'undefined') {
        // Передаем пустой объект или напрямую имя, чтобы Lampa не лезла внутрь твоего объекта plugin
        var p_capsule = { component: 'my_iptv2', name: 'Hack TV' };
        
        Lampa.SettingsApi.addParam(p_capsule, {
